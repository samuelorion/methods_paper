...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/samuelorion/methods_paper/tree/gh-pages) and [`output`](https://github.com/samuelorion/methods_paper/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://samuelorion.github.io/methods_paper/
+ **PDF manuscript** at https://samuelorion.github.io/methods_paper/manuscript.pdf
